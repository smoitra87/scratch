...
%
%   MEMBERS:
%     opt            : optional enum, defaults to int32(1).
%     learningRate   : optional double, defaults to double(0).
%     layers         : repeated <a href="matlab:help pb_read_Layer">Layer</a>, defaults to struct([]).
%
