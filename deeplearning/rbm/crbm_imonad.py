...
class RBM:
    ...
    def genData(self):
        """ Generates the manifold spiral by playing with circles """
        c1 = 0.5
        r1 = 0.4
        r2 = 0.3
    ...
    # Sigmoidal Function
    def sigFun(self, X, A):
		# Squashes between between lo and hi. What is A doing ?
        lo = 0.0
        hi = 1.0
    ...
    def activ(self, who):
        if(who==0):
			# Gets the activations for the visual neurons
    ...
    def learn(self, epochmax):
        ...
        for epoch in range(1,epochmax):
            ...
            # This is doing CD/grad descent on scaling factor in sigmoid for hidden layer
