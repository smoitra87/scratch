...
================================
-run_demo.ctf (component technology file)
-run_demo 
-run_run_demo.sh (shell script run to temporarily set environment variables and execute 
                  the application)
   -to run the shell script, type
   
       ./run_run_demo.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v717, run the shell script as:
       ...
       ./run_run_demo.sh /mathworks/home/application/v717
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_run_demo.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux systems:
   ...
   LD_LIBRARY_PATH by issuing the following commands:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_run_demo.sh 
